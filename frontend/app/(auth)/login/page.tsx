...
import { ShieldBan, ArrowRight, Lock, Mail, Loader2 } from 'lucide-react';
    ...
    <div className="w-full max-w-[440px] mx-auto z-10 zoom-in-95 duration-500 animate-in">
      <div className="premium-card rounded-[40px] p-10 border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden">
        ...
        <div className="text-center mb-10 relative z-10 flex flex-col items-center">
          <div className="w-20 h-20 rounded-[24px] bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(6,182,212,0.4)] border border-white/20">
            <ShieldBan className="w-10 h-10 text-white drop-shadow-md" />
          </div>
          <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 tracking-tight">
            System Login
          </h2>
          <p className="text-gray-400 mt-3 font-medium">Identify yourself to access the Sentinel.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6 relative z-10">
          <div>
            <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 flex items-center gap-2">
                <Mail className="w-4 h-4 text-cyan-500" /> Operator Email
            </label>
            <input 
              type="email" 
              required
              ...
              className="w-full bg-black/50 border border-white/10 rounded-2xl px-5 py-4 outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all text-white font-medium"
          ...
          <div>
             <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 flex items-center gap-2">
                <Lock className="w-4 h-4 text-indigo-500" /> Override Passcode
            </label>
            <input 
              type="password" 
              required
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-4 mt-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white rounded-2xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(6,182,212,0.4)] disabled:opacity-50 flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 group"
          >
        ...
        <p className="mt-8 text-center text-gray-500 font-medium relative z-10">
          ...
          <Link href="/register" className="text-cyan-400 hover:text-cyan-300 transition-colors font-bold underline underline-offset-4 decoration-cyan-400/30">
            Request Access
          </Link>
        </p>
      </div>
